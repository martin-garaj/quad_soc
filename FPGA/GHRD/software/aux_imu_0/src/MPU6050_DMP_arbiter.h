/*
 * MPU6050_DMP_arbiter.h
 *
 *  Created on: 29.5.2017
 *      Author: gartin
 */

#ifndef MPU6050_DMP_ARBITER_H_
#define MPU6050_DMP_ARBITER_H_

// other includes
#include <stdint.h> 		// uint8_t, uint16_t
#include "system_const.h"	// RETURN_ERROR, RETURN_SUCCESS
#include "API_I2C_module.h" // i2c functions
...
/*
// following is copy-pasted from q_MPU6050.hpp (this is C++ file, Nios II has problems with C++)
// line 65
#define MPU6050_ADDRESS_AD0_LOW     0x68 // address pin low (GND), default for InvenSense evaluation board
#define MPU6050_ADDRESS_AD0_HIGH    0x69 // address pin high (VCC)
#define MPU6050_DEFAULT_ADDRESS     MPU6050_ADDRESS_AD0_LOW
...
// the following is HARD-CODED value in MPU6050_9Axis_MotionApps41.h
// line 584
#define dmpPacketSize		48
