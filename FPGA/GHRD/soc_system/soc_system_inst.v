	soc_system u0 (
		.aux_imu_0_led_export                  (<connected-to-aux_imu_0_led_export>),                  //             aux_imu_0_led.export
		.aux_radio_0_led_export                (<connected-to-aux_radio_0_led_export>),                //           aux_radio_0_led.export
		.clk_clk                               (<connected-to-clk_clk>),                               //                       clk.clk
		.hpd_0_led_export                      (<connected-to-hpd_0_led_export>),                      //                 hpd_0_led.export
		...
		.i2c_0_scl_export                      (<connected-to-i2c_0_scl_export>),                      //                 i2c_0_scl.export
		.i2c_0_sda_export                      (<connected-to-i2c_0_sda_export>),                      //                 i2c_0_sda.export
		...
		.pwm_0_external                        (<connected-to-pwm_0_external>),                        //                     pwm_0.external
		.pwm_1_external                        (<connected-to-pwm_1_external>),                        //                     pwm_1.external
		.reset_reset_n                         (<connected-to-reset_reset_n>),                         //                     reset.reset_n
		.reset_0_export                        (<connected-to-reset_0_export>),                        //                   reset_0.export
		.select_0_export                       (<connected-to-select_0_export>),                       //                  select_0.export
