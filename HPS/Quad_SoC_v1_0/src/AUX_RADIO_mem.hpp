...
#ifndef AUX_RADIO_HPP_
#define AUX_RADIO_HPP_
...
#include "AUX_RADIO.h"	// aux_imu_mem
...
//						                                                      					//
//==============================================================================================//
class AUX_RADIO_mem : private API_mem {
// VARIABLES //
public:
...
public:
	...
	AUX_RADIO_mem(uint32_t * aux_radio_memory_virtual_address, int aux_radio_memory_length_dword);
	~AUX_RADIO_mem();
...
// VARIABLES
private:
	aux_radio_memory_map memory_map;
	int memory_length;
